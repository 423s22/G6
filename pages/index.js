...
import {
  Page, Layout,  Router, Card, TextStyle, Thumbnail, Button, ButtonGroup,  AppProvider, EmptyState,  CalloutCard, MediaCard} from "@shopify/polaris";
        ...
        <Page title="Rival Dynamic Pricing">
          <Card title="About this app" sectioned>
            <p>
              ...
              is shown at the cart once you've finalized your purchases but
              fails to show the pricing when you are shopping.
            </p>
          </Card>
          <CalloutCard
          ...
          >
            <p>
              {" "}
              The button below will lead you to the product management page,
              where you may add products and their respective variations.
            </p>
          </CalloutCard>
          ...
          >
            <p>
              If you have any questions on how to use the app please refer 
              to the FAQ, there you will help on how to create, delete and modify
              products.
            </p>
          </CalloutCard>
          ...
          <MediaCard
  title="About Us"
  description="Rival is a group of MSU students who are enthusiatic about
  creating a user friendly dynamic pricing app for Shopify. The group is made up
