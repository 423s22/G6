...
<h4> Riley Slater:   </h4>
<p> Riley worked on front-end tests. Additionally, while creating tests, he found a major but that was from a third party software which was making our program not compile and execute properly. Riley's tests are used to test the embedded app block functionality. </p>
<h4> Alyssa Newhart:  </h4>
<p> Alyssa focused on creating components like show options and get requests. As a team, she helps a lot with delegating work and properly structure what we need to complete. </p>
<h4> James Marsh: </h4>
<p> James worked on testing with Riley, but more importantly he worked on the theme extension code. This is also one our more important tasks since we are trying to create an embedded app block which will be inserted into our themed app store. </p>
<h4> Will Cook: </h4>
<p> Will cook had an extremely important role in creating the database. He worked with the back end of creating things like product ID routing. Will is a great team member and has been constantly helping every person. </p>
